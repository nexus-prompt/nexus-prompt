...
describe('StorageService', () => {
  ...
  describe('getDefaultFramework', () => {
    ...
    it('defaultFrameworkIdが無効な場合、最初のフレームワークにフォールバックする', async () => {
      ...
      const testData = createMockAppData({
        frameworks: [framework1, framework2],
        settings: { defaultFrameworkId: 'non-existent-id', initialized: true, version: '1.0.0', language: 'ja' },
      });
  ...
  describe('saveFramework', () => {
    ...
    it('新しいフレームワークを追加する', async () => {
      ...
      const testData = createMockAppData({
        ...
        settings: { defaultFrameworkId: 'fw1', initialized: true, version: '1.0.0', language: 'ja' },
      });
  ...
  describe('getPrompts', () => {
    it('プロンプトを取得する', async () => {
      ...
      const testData = createMockAppData({
        ...
        prompts: testPrompts,
        settings: { defaultFrameworkId: testFramework.id, initialized: true, version: '1.0.0', language: 'ja' },
      });
